...
Letter frequency is the perhaps the most basic strategy for choosing a letter. The idea being that, you choose the letter that most frequenlty occurs in the set of possible words.
This was the first heuristic implemented and is currently being evaluated by testing every word in the Collins Scrabble Words (2019) dictionary.
